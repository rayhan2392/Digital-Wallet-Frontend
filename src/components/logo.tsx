    ...
    <div className="flex items-center space-x-3 group">
      <div className="relative">
        <svg
          ...
          height="36"
          fill="currentColor"
          className="text-primary transition-all duration-300 group-hover:scale-110 group-hover:rotate-3"
        >
      ...
      <span className="fintech-gradient-text text-2xl font-bold tracking-tight">
        SwiftPay
      </span>
    </div>
  )
